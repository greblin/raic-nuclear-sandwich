...
class InitializerStep8_InterruptConsolidate(CommandBuilder):
    def get_command_list(self):
        ...
        for offset, column in {
           ...
           prepared_commands.append(Action.move(offset * (Constant.CELL_DELIMITER_SIZE - Constant.UNIT_INITIAL_DISTANCE), 0, 0.18))
